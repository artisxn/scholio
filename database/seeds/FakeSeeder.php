...
//
//
//        /*===============   21 MEDITERRANEAN COLLEGE THESSALONIKI  ================*/
//        $school1 = factory(App\Models\School::class)->create([
//            'user_id' => factory(App\User::class)->create(['name' => 'Mediterranean College', 'email' => 'infoThess@medcollege.edu.gr', 'password' => bcrypt('123456'), 'role' => 'school', 'username' => 'medThess'])->id,
//            'address' => 'Εγνατία 2-4, Κτίριο «ΒΙΕΝΝΗ»',
//            'city' => 'Θεσσαλονίκη',
//            'phone' => 2310287779  ,
//            'type_id' => 1,
//            'website' => 'medcollegeThess.edu.gr',
//            'approved' => 1,
//            'about' => 'Στον εικοστό πρώτο αιώνα, το Mediterranean College, σε συνεργασία με ισχυρά πανεπιστήμια του εξωτερικού, αναδύεται ως ένα ιδιωτικό ίδρυμα ανώτατης εκπαίδευσης με ηγετικό ρόλο στους κλάδους σπουδών της Οικονομίας, της Διοίκησης, της Πληροφορικής, των Ανθρωπιστικών Επιστημών,του Τουρισμού, των Επαγγελμάτων Υγείας,  των Μηχανικών προσφέροντας προγράμματα υψηλής ποιότητας σε ένα περιβάλλον γαλούχησης όπου η ποιότητα υπαγορεύεται πάντα από τις ανάγκες των φοιτητών. Για να πραγματοποιήσει το όραμά του για ακαδημαϊκή διάκριση, επιτυχία των φοιτητών του, εκπαιδευτική και τεχνολογική καινοτομία, καθώς και για κοινωνική προσφορά, το Κολλέγιο προσελκύει και εξασφαλίζει αφοσιωμένους επαγγελματίες και εκπαιδευτικό προσωπικό με εξαιρετικές ικανότητες, αναγνωρισμένο για την εξειδίκευσή του στον τομέα της διδασκαλίας, της καθοδήγησης φοιτητών, της κατάρτισης, της έρευνας και της παροχής υπηρεσιών. Δομημένο σε αυτές τις σταθερές βάσεις και αρχές, το MC, αποσκοπεί στην υλοποίηση του οράματός του, να γίνει ένα μοναδικό διεθνές κέντρο μάθησης στον ελλαδικό χώρο.',
//            'logo' => 'fake/med-logo.png',
//            'background' => 118,
//        ]);
//
...
//        /*===============  29 AKMH ΗΡΑΚΛΕΙΟ================*/
//        $school3 = factory(App\Models\School::class)->create([
//            'user_id' => factory(App\User::class)->create(['name' => 'ΑΚΜΗ', 'email' => 'infoHer@iek-akmi.edu.gr', 'password' => bcrypt('123456'), 'role' => 'school', 'username' => 'akmiHer'])->id,
...
//        /*===============  31 AKMH ΛΑΡΙΣΑ ================*/
//        $school3 = factory(App\Models\School::class)->create([
//            'user_id' => factory(App\User::class)->create(['name' => 'ΑΚΜΗ', 'email' => 'infoLar@iek-akmi.edu.gr', 'password' => bcrypt('123456'), 'role' => 'school', 'username' => 'akmiLAr'])->id,
...
//        for ($i = 0; $i < 9; $i++) {
        ...
        $this->createStudy($school13, [216, 217, 208, 209, 211, 254, 256, 260, 306, 308, 309, 312, 324]);
        $this->createUsers($school13, 'students', [22, 24, 26, 27, 28, 29,31, 36, 37,40,41,]);
        ...
        $this->createScholarship($school14->id, 1, 20, 210, 1, 1, 1, 1);
        ...
        $this->createUsers($school16, 'students', [21, 22, 23, 24, 25, 26, 27]);
        ...
        /*===============   17 ΙΣΤ   ================*/
        $this->createImages($school17, 'fake/att-', 1, 5);
        $this->createStudy($school17, [265, 268, 269, 216, 217, 208, 209, 211, 254, 256, 279, 306, 308, 309, 312, 324]);
        $this->createUsers($school17, 'students', [21, 22, 23, 24, 25, 26, 27]);
        $this->createUsers($school17, 'teachers', [51, 52, 53, 54]);
        $this->createScholarship($school17->id, 1, 40, 265, 1, 1, 1, 1);
        $this->createScholarship($school17->id, 2, 800, 312, 3, 2, 2, 2);
        $this->createScholarship($school17->id, 1, 30, 226, 1, 3, 2, 1);
        $this->createScholarship($school17->id, 2, 500, 269, 1, 4, 2, 1);
        $this->createScholarship($school17->id, 2, 300, 308, 1, 2, 2, 2);
        $this->createScholarship($school17->id, 2, 800, 310, 3, 2, 2, 2);
