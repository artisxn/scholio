...
class LevelsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $levels = [
            ...
            ['id' => 4, 'type_id' => 3, 'name' => 'Γ Λυκείου'],
            ['id' => 5, 'type_id' => 3, 'name' => 'Β Λυκείου'],
            ['id' => 6, 'type_id' => 3, 'name' => 'Α Λυκείου'],
            ['id' => 7, 'type_id' => 6, 'name' => 'Γ Λυκείου'],
            ['id' => 8, 'type_id' => 6, 'name' => 'Β Λυκείου'],
            ['id' => 9, 'type_id' => 6, 'name' => 'Α Λυκείου'],
            ['id' => 10, 'type_id' => 3, 'name' => 'Γ Γυμνασίου'],
            ['id' => 11, 'type_id' => 3, 'name' => 'Β Γυμνασίου'],
            ['id' => 12, 'type_id' => 3, 'name' => 'Α Γυμνασίου'],
            ['id' => 13, 'type_id' => 7, 'name' => 'Γ Γυμνασίου'],
            ['id' => 14, 'type_id' => 7, 'name' => 'Β Γυμνασίου'],
            ['id' => 15, 'type_id' => 7, 'name' => 'Α Γυμνασίου'],
            ['id' => 16, 'type_id' => 8, 'name' => 'ΣΤ Δημοτικού'],
            ['id' => 17, 'type_id' => 8, 'name' => 'Ε Δημοτικού'],
            ['id' => 18, 'type_id' => 8, 'name' => 'Δ Δημοτικού'],
            ['id' => 19, 'type_id' => 8, 'name' => 'Γ Δημοτικού'],
            ['id' => 20, 'type_id' => 8, 'name' => 'Β Δημοτικού'],
            ['id' => 21, 'type_id' => 8, 'name' => 'Α Δημοτικού'],
            ...
            // ['id' => 1,'type_id' => 3, 'name' => 'Κάθε Τάξη'],
            // ['id' => 1, 'type_id' => 6, 'name' => 'Κάθε Τάξη'],
            // ['id' => 1,'type_id' => 7, 'name' => 'Κάθε Τάξη'],
            // ['id' => 1,'type_id' => 8, 'name' => 'Κάθε Τάξη'],
            // ['id' => 1,'type_id' => 4, 'name' => 'Κάθε Επίπεδο'],
            // ['id' => 1,'type_id' => 10, 'name' => 'Κάθε Επίπεδο'],
            // ['id' => 1,'type_id' => 11, 'name' => 'Κάθε Επίπεδο'],
