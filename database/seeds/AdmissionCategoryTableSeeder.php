...
class AdmissionCategoryTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $categories = [
            ...
            // ['name' => 'Προηγούμενες Σπουδές', 'icon' => ''],
            // ['name' => 'Έπαινοι - Διακρίσεις', 'icon' => ''],
            // ['name' => 'Ενδιαφέροντα - Ασχολίες', 'icon' => ''],
            // ['name' => 'Πιστοποιήσεις - Σεμινάρια', 'icon' => ''],
            // ['name' => 'Σημειώσεις', 'icon' => ''],
            // ['name' => 'Σημειώσεις Εκ. Ιδρύματος', 'icon' => ''],
        ];
