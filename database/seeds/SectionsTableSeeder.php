...
class SectionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $categories = [
            ...
            ['id' => 31, 'name' => 'Οικονομία & Διοίκηση'],                         /** IEK Επαγγελματικές Σπουδές 21-34 */
            ['id' => 31, 'name' => 'Επαγγέλματα Υγείας'],
            ['id' => 31, 'name' => 'Οπτικοακουστικά & Τέχνες'],
            ['id' => 31, 'name' => 'Τεχνικά Επαγγέλματα'],
            ['id' => 31, 'name' => 'Τουριστικά-Επισιτιστικά'],
            ['id' => 31, 'name' => 'Μόδα & Ομορφιά'],
            ['id' => 31, 'name' => 'Αισθητική & Spa'],
            ['id' => 31, 'name' => 'Παιδαγωγικά'],
            ['id' => 31, 'name' => 'Ηχοληψία & Μουσική Τεχνολογία'],
            ['id' => 31, 'name' => 'ΗΥ & Νέες Τεχνολογίες'],
            ['id' => 31, 'name' => 'Εφαρμοσμένες Τέχνες'],
            ['id' => 31, 'name' => 'ΜΜΕ & Αθλητισμός'],
            ['id' => 31, 'name' => 'Αγροτική Κατάρτιση - Γεωργικές Σπουδές - Γεωπονία'],
            ['id' => 31, 'name' => 'Φροντίδα Ζώων'],

            ['id' => 4, 'name' => 'Ομάδα Προσανατολισμού'],                     /** Φροντιστήρια Μέσης Εκπαίδευσης 35-38 */
            ['id' => 5, 'name' => 'Ομάδα Προσανατολισμού'],
            ['id' => 6, 'name' => 'Γενική Παιδεία'],
