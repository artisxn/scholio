...
class SectionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $categories = [
            ...
            ['id' => 33, 'name' => 'Γενική Παιδεία'], /** Ιδιωτικά Γυμνάσια Λύκεια */
            ['id' => 34, 'name' => 'Γενική Παιδεία'],
            ['id' => 35, 'name' => 'Γενική Παιδεία'],

            ['id' => 36, 'name' => 'Παιδικός Σταθμός'],
            ['id' => 37, 'name' => 'Νήπια'],
            ['id' => 37, 'name' => 'Προνήπια'],

            ['id' => 38, 'name' => 'Εκπαιδευτική Ρομποτική'],
            ['id' => 39, 'name' => 'Εκπαιδευτική Ρομποτική'],
            ['id' => 40, 'name' => 'Εκπαιδευτική Ρομποτική'],
            ['id' => 41, 'name' => 'ΗΥ & Ρομποτική'],
