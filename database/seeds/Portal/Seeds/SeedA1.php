...
class SeedA1 extends Seeder
{
    ...
    public function run()
    {
        ...
        Scholio::portalStudy($robotsetgo, 'Τμήμα Προχωρημένων', 'ΗΥ & Ρομποτική', 'Δεξιότητες ρομποτικής και αυτοματισμού', 'http://www.robotsetgo.gr/product/%CE%B4%CE%B5%CE%BE%CE%B9%CF%8C%CF%84%CE%B7%CF%84%CE%B5%CF%82-%CF%81%CE%BF%CE%BC%CF%80%CE%BF%CF%84%CE%B9%CE%BA%CE%AE%CF%82-%CE%BA%CE%B1%CE%B9-%CE%B1%CF%85%CF%84%CE%BF%CE%BC%CE%B1%CF%84%CE%B9%CF%83/');
        Scholio::portalStudy($robotsetgo, 'Τμήμα Προχωρημένων', 'ΗΥ & Ρομποτική', 'Τρισδιάστατη 3D σχεδίαση', 'http://www.robotsetgo.gr/product/%CF%84%CF%81%CE%B9%CF%83%CE%B4%CE%B9%CE%AC%CF%83%CF%84%CE%B1%CF%84%CE%B7-3d-%CF%83%CF%87%CE%B5%CE%B4%CE%AF%CE%B1%CF%83%CE%B7/');
        Scholio::portalStudy($robotsetgo, 'Τμήμα Προχωρημένων', 'ΗΥ & Ρομποτική', 'Μαθήματα Χειρισμού και Προγραμματισμού Ηλεκτρονικών Υπολογιστών', 'http://www.robotsetgo.gr/product/%CE%BC%CE%B1%CE%B8%CE%AE%CE%BC%CE%B1%CF%84%CE%B1-%CF%87%CE%B5%CE%B9%CF%81%CE%B9%CF%83%CE%BC%CE%BF%CF%8D-%CE%BA%CE%B1%CE%B9-%CF%80%CF%81%CE%BF%CE%B3%CF%81%CE%B1%CE%BC%CE%BC%CE%B1%CF%84%CE%B9%CF%83/');
        Scholio::portalStudy($robotsetgo, 'Τμήμα Προχωρημένων', 'ΗΥ & Ρομποτική', 'Μαθήματα προγραμματισμού κινητών τηλεφώνων Android', 'http://www.robotsetgo.gr/product/%CE%BC%CE%B1%CE%B8%CE%AE%CE%BC%CE%B1%CF%84%CE%B1-%CF%80%CF%81%CE%BF%CE%B3%CF%81%CE%B1%CE%BC%CE%BC%CE%B1%CF%84%CE%B9%CF%83%CE%BC%CE%BF%CF%8D-%CE%BA%CE%B9%CE%BD%CE%B7%CF%84%CF%8E%CE%BD-%CF%84%CE%B7/');
