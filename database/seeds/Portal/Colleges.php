...
<p style="text-align: justify;"></p>',
        ...
        Scholio::portalStudy($school2, 'Προπτυχιακές Σπουδές-Bachelor', 'Ανθρωπιστικές Επιστήμες - Humanities and Social Sciences', 'BSc (Hons) Psychology (Ψυχολογία)', 'http://www.mitropolitiko.edu.gr/el/proptyxiaka-programmata-bachelors/mitropolitiko-kollegio-sxoli-anthrwpistikwn-epistimwn');
...
<p style="text-align: right;"><br /><strong>Dr. Elias Foutsis</strong><br />President</p>',
        ...
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc Accounting and Finance (University of London)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/logistiki-kai-xrimatooikonomika-bsc-accounting-and-finance');
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc Banking and Finance (University of London)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/trapeziki-kai-xrimatooikonomika-bsc-banking-and-finance');
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc Business and Management (University of London)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/dioikisi-kai-diaxeirisi-epixeiriseon-bsc-business-and-management');
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BA Business Studies (University of Northampton)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/dioikis-epixeiriseon-business-studies');
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc Development & Economics (University of London)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/anaptiksi-kai-xrimatooikonomika-bsc-development-economics');
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc Economics (University of London)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/oikonomika-bsc-economics');
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc Economics and Finance (University of London)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/oikonomika-kai-xrimatooikonomika-bsc-economics-finance');
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc Economics and Management (University of London)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/oikonomika-kai-dioikitiki-bsc-economics-and-management');
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc Economics and Politics (University of London)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/oikonomika-kai-politiki-bsc-economics-and-politics');
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc International Development (University of London)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/diethneis-anaptyksi-bsc-international-development');
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc International Relations (University of London)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/diethneis-sxeseis-bsc-international-relations');
        Scholio::portalStudy($school7, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc Politics & International Relations (University of London)', 'https://www.dei.edu.gr/el/proptuxiaka-programmata/tmhma-oikonomikwn-k-dioikhshs-epixeirhsewn/politika-kai-dietnheis-sxeseis-bsc-politics-international-relations');
        ...
        Scholio::portalStudy($school10, 'Μεταπτυχιακές Σπουδές-Master', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'Banking & Finance - MSc', 'http://citycollege.sheffield.eu/frontend/articles.php?cid=47&t=MSc-in-Banking-&-Finance');
        Scholio::portalStudy($school10, 'Μεταπτυχιακές Σπουδές-Master', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'Digital Marketing and Social Media - MA', 'https://citycollege.sheffield.eu/frontend/articles.php?cid=41&t=MA-in-Digital-Marketing-and-Social-Media');
        ...
        // Scholio::portalSocial($school, 'skype', '');Î
...
​                        <p>Σήμερα, μετά από 39 χρόνια μπορούμε και σας μιλάμε για δομές και συνεργασίες κύρους, με διεθνή αποδοχή, για παροχή σύγχρονης Πανεπιστημιακής εκπαίδευσης.
        ...
        Scholio::portalStudy($school20, 'Προπτυχιακές Σπουδές-Bachelor', 'Agriculture - Environment - Life Sciences', 'BSc Food Science & Technology - Επιστήμη & Τεχνολογία Τροφίμων', 'http://www.perrotiscollege.edu.gr/food-science-technology/');
        Scholio::portalStudy($school20, 'Προπτυχιακές Σπουδές-Bachelor', 'Διοίκηση Επιχειρήσεων & Οικονομικά - Business', 'BSc International Business - Διεθνής Επιχειρηματικότητα', 'http://www.perrotiscollege.edu.gr/international-business/');
