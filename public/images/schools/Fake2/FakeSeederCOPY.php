...
//        for ($i = 0; $i < 9; $i++) {
        ...
        $this->createScholarship($school1->id, 2, 800, 310, 3, 2, 2, 2);
        $this->createScholarship($school1->id, 1, 80, 279, 2, 2, 2, 2);
        ...
        $this->createStudy($school13, [210, 211, 212, 216, 217, 208, 230, 209, 211, 254, 256, 260, 306, 308, 309, 312, 324]);
...
//        $this->createUsers($school18, 'students', [21, 22, 23, 24, 25, 26, 27]);
//        $this->createUsers($school18, 'teachers', [51, 52, 53, 54]);
...
//        $this->createUsers($school19, 'teachers', [51, 52, 53, 54]);
