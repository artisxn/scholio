...
<div class="container mainBody">
    <div class="outerBox">
        ...
        <p class="terms">
            Για κάθε εκπαιδευτικό ίδρυμα η δημιουργία του βασικού προφίλ (το οποίο περιλαμβάνει τα στοιχεία επικοινωνίας, χάρτη, φωτογραφιές προβολής, και λίγα λόγια για το εκπαιδευτικό ίδρυμα) είναι δωρεάν. 
        </p>
