        ...
        <div class="entered-text margin-bot-50 margin-top-50">
            ...
            <div class="row font-weight-300">
                ...
                <div class="col-sm-6 col-lg-3 margin-top-20">
                    ...
                    <div class="margin-bot-3"><a class="sc-t-light-gray" href="">Ξενες Γλωσσες Θεσσαλονικη</a></div>
                    <div class="margin-bot-3"><a class="sc-t-light-gray"  href="">Ξενες Γλωσσες Πειραιας</a></div>
                    <div class="margin-bot-3"><a class="sc-t-light-gray"  href="">Ξενες Γλωσσες Ηλιουπολη</a></div>
                </div>
