    ...
    <div class="container">
        <div class="row" >
            <div class="pull-left pad-top-50 text-incr-125 left-section" >
                ...
                <span class="pad-top-10 pad-bot-10 clear-fix margin-right-20 ">                   <a href="{{ url('site-map/schools') }}" class="sc-t-white social-link">@lang('main.footer.schools')</a></span>
                <span class="pad-top-10 pad-bot-10 clear-fix">                   <a href="{{ url('site-map/scholarships') }}" class="sc-t-white social-link">@lang('main.footer.scholarships')</a></span>
