<style>
    ...
    .btn-school-results,.btn-scholarship-results,.btn-home{ border-radius: 5px; padding: 10px 6px; font-size: 95%; position: absolute; bottom: 163px; left: 17px; right: 17px; text-align: center;  background-color: #eee!important; color: #555!important;width: 220px; }
    .btn-home{bottom: 112px; background-color: #aaa!important; color: #fff!important; }
    .btn-scholarship-results{bottom: 214px}
    ...
    .btn-register2{background-color: #FD6A33; bottom: 70px; }
