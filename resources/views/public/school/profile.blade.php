...
<head>
    ...
    <meta property="fb:pages" content="934370089973049" /> @include('google.main')
    ...
    </script> @include('public.window-lang')
...
<body data-spy="scroll" data-target=".spy" data-offset="270" id="home" ng-app="profileApp" ng-controller="profileCtrl" data-ng-init="init()"
    ng-cloak>
                ...
                <div class="pull-right visible-md visible-lg">
                    <ul class="nav navbar-nav navbar-right sc-landing-menu">
                        ...
                        <li class="sc-landing-menu-item ">
                            <a href="#sxetika" class="school-profile-nav-link ">@lang('profile.navigation.about')</a>
                        </li>@endif @if($school->settings->studies && count($school->study) > 0)
                        <li ng-show="studies.length && col_iek_eng_dan_mus"
                            class="sc-landing-menu-item">
                            <a href="#spoudes" class="school-profile-nav-link ">@lang('profile.navigation.studies')</a>
                        </li>@endif @if($school->settings->scholarships && count($school->scholarship) > 0)
                        <li class="sc-landing-menu-item">
                            <a href="#ypotrofies" class="school-profile-nav-link">@lang('profile.navigation.scholarships')</a>
                        </li>@endif @if($school->settings->teachers && count($school->teachers) > 0)
                        <li class="sc-landing-menu-item">
                            <a href="#faculty" class="school-profile-nav-link">@lang('profile.navigation.teachers')</a>
                        </li>@endif @if($school->settings->reviews && count($school->reviews) > 0)
                        <li class="sc-landing-menu-item">
                            <a href="#reviews" class="school-profile-nav-link">@lang('profile.navigation.reviews')</a>
                        </li>@endif
                        ...
                        <li class="langDropWhite " style="margin-top: 15px;">
                            <form method="GET" id="langForm">
                                <select onchange="changeLang(this)" class="selectpicker select-white landDrop school-profile-lang" data-live-search="false"
                                    data-mobile="false" data-size='2' data-width="100%" data-style="btn-white">
                        ...
                        <li>
                            <a href="{{ url('/register/role') }}">
                                <button type="button" class="sc-button-landing sc-button sc-green sc-t-white" {{--data-toggle="modal"
                                    data-target="#select-modal" --}}>@lang('main.navigation.register')</button>
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('/login') }}">
            ...
            <div class="container container-profile" style="overflow-x: hidden">
                ...
                <div class="up">
                    <div class=" margin-bot-15 ">
                        <div class="">
                            <div class="xs-center">
                                <img id="img1" class=" pull-left margin-right-10 margin-top-15 margin-bot-10" ng-src="@{{contactInfo.logo}}">
                            </div>
                            ...
                            <div class=" xs-centered-text">
                                ...
                                <span class="pad-top-5 xs-pad-top xs-review">
                                    ...
                                    <span ng-show="contactInfo.ratingCounter!=0">
                ...
                <div class="row">
                    ...
                    @if($school->admin->subscription->plan_id == 2) @if(auth()->check()) @if(auth()->user()->role != 'school') @if(auth()->user()->apply->contains($school))
                    ...
                    <div class="col-lg-9 col-md-9 margin-top-30 margin-bot-25">
                        ...
                        <div class="sc-t-grey hidden-lg hidden-md visible-sm visible-xs clearfix">
                            <div class="col-xs-12 margin-top-10 stats-box-xs">
                                ...
                                <div class="col-xs-7 col-sm-7 pad-left-0 xxs-custom-contact">
                                    ...
                                    <span>
                                        <i class="fa fa-map-marker pad-top-3 xs-text-incr-85 " aria-hidden="true"></i>
                                    </span>
                                    ...
                                    <div class="">
                                        <span>
                                            <i class="fa fa-street-view pad-top-3 " aria-hidden="true"></i>
                                        </span>
                                    ...
                                    <div class="pad-top-10"></div>
                                    <span>
                                        <i class="fa fa-phone pad-top-2 xs-text-incr-85" aria-hidden="true"></i>
                                    </span>
                                    <span class="pad-left-5">@{{contactInfo.phone}}</span>

                                    <div class="pad-top-10"></div>
                                    <span>
                                        <i class="fa fa-envelope  pad-top-2 " aria-hidden="true"></i>
                                    </span>
                                    <span class="pad-left-5 ">
                                        <a href="mailto:@{{contactInfo.email}}" class="school-links">@{{contactInfo.email}}</a>
                                    </span>

                                    <span ng-if="contactInfo.website">
                                        <div class="pad-top-10"></div>
                                        <span>
                                            <i class="fa fa-globe pad-top-3 xs-text-incr-85" aria-hidden="true"></i>
                                        </span>
                                        <span class="pad-left-5">
                                            <a href="https://@{{contactInfo.website}}/" target="_blank" class="school-links">@{{contactInfo.website}}</a>
                                        </span>
                                    </span>
                        ...
                        @endif @if($school->settings->studies)
                            ...
                            <div id="sliderStudies" class=" main-box-2 slideup">
                                <div class="section-header2">
                                    <p class="title margin-left-20 pad-top-40 text-incr-175 font-weight-300">
                                        <i class="fa fa-book fa-linear4 margin-right-10" aria-hidden="true"></i>
                                        <span>@lang('profile.cards.studies') </span>
                                    </p>
                                </div>
                                ...
                                <div ng-if="col_iek_eng_dan_mus">
                                    <div ng-repeat="(levIndex, level) in levelsName">
                                        <ul ng-class="[{'col-md-6': (levelsName.length>1)},{'clearFloat': (levelsName.length>1)&&( levIndex+1)%2 ==1 },  'col-sm-12']"
                                            ...
                                            <div class=" text-incr-150 font-weight-300 margin-top-30 margin-left-10" style="margin-bottom: 0" ng-if="contactInfo.type_id!=2">
                                            @{{ level }} </div>


                                            <ul ng-repeat="(secIndex, section) in sectionsName[$index]" ng-class="[{'col-lg-6': (contactInfo.type_id==2)},{'clearFloat': (( secIndex+1)%2 ==1)}]"
                                                style="list-style-type: none;  padding-top: 16px;">

                                                <li class="margin-top-10 margin-left-10">
                                                    <img ng-src="@{{ sectionsIcon[levIndex][secIndex] }}" alt="" style="height: 22px; margin-top: -12px; filter: grayscale(80%); opacity: 0.8">
                                ...
                                <div ng-if=" (contactInfo.type_id==3 || contactInfo.type_id==6)" style="overflow-x: hidden">
                                    <div class="col-md-6 col-sm-12" style="margin-bottom: 40px;">
                                        ...
                                        <div ng-repeat="(levIndex, level) in levelsName ">
                                            <ul>
                                                <div class="pad-left-20 font-weight-300 " style=""> @{{ level}} </div>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div ng-if="sxoleio">
                                    <div ng-repeat="(levIndex, level) in levelsName">
                                        <ul ng-class="[{'col-md-4': (levelsName.length>1)},{'clearFloat': (levelsName.length>1)&&( levIndex+1)%2 ==3 },  'col-sm-12']"
                                            style="padding-bottom: 20px;">
                                            <div class=" text-incr-150 font-weight-300 margin-top-30 margin-left-10" style="margin-bottom: 0" ng-if="contactInfo.type_id!=2">
                                            @{{ level }} </div>
                                        </ul>
                        ...
                        @endif @if($school->settings->scholarships && count($school->scholarship) > 0)
                        <!-- Υποτροφίες -->
                        <div class="slideup slideScholarships" id="ypotrofies" ng-if="contactInfo.activeScholarships" style="overflow-x: hidden;"
                            ng-style="(studies.length<6 || !col_iek_eng_dan_mus) && {'margin-top':'30px'}">
                            <div class="section-header3">
                                <p class=" title margin-left-20 pad-top-40 text-incr-175 font-weight-300">
                                    <i class="fa fa-trophy fa-linear4 margin-right-10" aria-hidden="true"></i>
                                    <span>@lang('profile.cards.scholarships') </span>
                                </p>
                            </div>


                            <div class=" scholar-box col-sm-12">
                                <div ng-repeat="scholarship in contactInfo.scholarship | limitTo:4" class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="height: 400px!important; position: relative; margin: 20px 0 ; padding-left: 40px;">

                                    <div class="scholar-frame " ng-class="{'sm-margin-left':($index%2==1)}">
                                        <div class="ribbon-wrapper">
                                            <div class="ribbon-front sc-medium-grey">
                                                {{--
                                                <i class="fa fa-diamond sc-t-white pad-left-20 text-incr-150 margin-top-10"
                                                    aria-hidden="true"></i>--}}
                                                <span class="">
                                        ...
                                        <div class="hexagon" style="top: 93px;">--}} {{--
                                            <i class="fa fa-pencil text-incr-200 sc-t-green text" aria-hidden="true" --}} {{--style=" position: relative; top: 3px; left: 17px; z-index: 2;"></i>--}} {{--
                                        ...
                                        <div class="scholar-content sc-t-grey font-weight-400">
                                            ...
                                            <div class="scholar-left xxs-up2" style="margin-right: 10px; color: #464646;" ng-class="{'margin-top-50': (contactInfo.type_id!=1 && contactInfo.type_id!=2 && contactInfo.type_id!=3),'margin-top-0': (contactInfo.type_id==1 || contactInfo.type_id==2 || contactInfo.type_id==3) }"
                                                ng-if="scholarship.multiple == 0">
                                                @{{scholarship.study.name}}
                                            </div>
                                            <div class="scholar-left xxs-up2" style="margin-right: 10px; color: #464646;" ng-class="{'margin-top-50': (contactInfo.type_id!=1 && contactInfo.type_id!=2 && contactInfo.type_id!=3),'margin-top-0': (contactInfo.type_id==1 || contactInfo.type_id==2 || contactInfo.type_id==3) }"
                                                ng-if="scholarship.multiple == 1">
                                            ...
                                            <div>
                                                <img ng-if="scholarship.financial_id==1" style="height: 34px; top: -6px; left: 5px;" class="hex1-img" ng-src="/panel/assets/images/steps/step1-reduce2.png">
                                                <img ng-if="scholarship.financial_id==2" style="height: 37px; top: -6px; left: 19px;" class="hex1-img" ng-src="/panel/assets/images/steps/step1-hand2.png">
                                                <img ng-if="scholarship.financial_id==3" style="height: 38px; top: -8px; left: 10px;" class="hex1-img" ng-src="/panel/assets/images/steps/step1-clock2.png">
                                            </div>
                                        ...
                                        <div class="xxs-text" ng-class="{'text-up':contactInfo.type_id!=1}">
                                            <div style="position: absolute; top: 282px; width: 145px" class="font-weight-400 sc-t-grey" ng-if="scholarship.interests>3">
                                                <span class="" style="">
                                                    ...
                                                    <span class="pull-right" ng-bind="scholarship.interests"></span>
                                                </span>
                                            </div>
                                            ...
                                            <div style="position: absolute; top: 301px; width: 145px" class="font-weight-400 sc-t-grey" ng-if="scholarship.length>2">
                                                <span class="" style="">
                                                    ...
                                                    <span class="pull-right"> @{{ scholarship.length}}</span>
                                                </span>
                                            </div>
                                        ...
                                        <ul class="like-btn">
                                            <a href="">
                                                <button id="b@{{scholarship.id}}" type="button" ng-click="interested(scholarship.id, $index)"
                                        ...
                                        <ul class="show-btn">
                                            <a href="/scholarship/@{{scholarship.id}}">
                                                <button type="button" class="sc-button-landing sc-button sc-green sc-t-white provoli">
                                                    <i class="fa fa-file-text-o margin-right-10" aria-hidden="true"></i> @lang('profile.scholarship.show')</button>
                                            </a>
                                            {{--
                                        ...
                                        {{--
                                        <div ng-if="($index%2==0)" class="hidden-xs hidden-sm" --}} {{--style="border-right: 1px solid #dbdbdb; height: 355px; position: absolute; top: 18px; right:  5px"></div>--}} {{--
                        ...
                        <div class="show-more" style="background-color: #fff">
                            ...
                            <div class="pad-top-20">
                                ...
                                <span ng-click="showMoreScholarships('ypotrofies')">@{{textScholarships}}
                                    <i class="@{{ iconScholarships }}"></i>
                                </span> --}}

                                <span>
                                    <a class="more-scholarships-text" href="{{ url('/public/scholarships?q=' . $school->admin->name) }}"
                                        target="_blank">@{{textScholarships}}</a>
                                </span>
                            </div>
                        </div>
                        @endif @if($school->settings->teachers && count($school->teachers) > 0)
                        <!-- Διδακτικό Προσωπικό  -->
                        <div class="slideTeachers slideup margin-bot-25" id="faculty" style="overflow-x: hidden">
                            <div class="section-header3">
                                <p class=" title margin-left-20 pad-top-40 text-incr-175 font-weight-300">
                                    <i class="fa fa-graduation-cap fa-linear4 text-incr-115 margin-right-10" aria-hidden="true"></i>
                                    <span>@lang('profile.cards.teachers') </span>
                                    </span>
                                </p>
                            </div>
                        ...
                        <div class="show-more" style="background-color: #fff">
                            <div class="pad-top-20">
                                <span ng-click="showMoreTeachers('faculty')">@{{textTeachers}}
                                    <i class="@{{ iconTeachers }}"></i>
                                </span>
                            </div>
                        </div>
                        @endif @if($school->settings->reviews && count($school->reviews) > 0)
                        <!-- Αξιολογησεις -->
                        <div class="slideReviews slideup margin-bot-25 " id="reviews" style="overflow-x: hidden">
                                ...
                                <div class="row font-weight-400 sc-t-grey col-xs-12 col-lg-8 col-lg-pull-4 xs-stars">
                                    ...
                                    <div ng-repeat="review in contactInfo.avgReviews">
                                        ...
                                        <div class="col-xs-12 col-sm-6" style="margin-left: -12px; margin-bottom: 9px;">
                                            <span id="catReview-@{{$index}}" ng-init="categoryReview($index, review.stars)" value="@{{review.stars}}" class="margin-left-20 raty"
                                                id="studyProgram"></span>
                            ...
                            <div id="reviews-container" ng-repeat="review in contactInfo.reviews">
                                <hr class="sc-t-grey" /> {{-- @{{ contactInfo.reviews }} --}}
                                <div class="col-lg-12">
                                    <div class="margin-left-10  person-review">
                                        ...
                                        <span class="sc-t-grey">
                                            <div class="raty" id="totalRating-@{{review.id}}" ng-init="rate(review.id, review.average)">@{{ review.average }}</div>
                                        </span>
                                        <br />
                        ...
                        <div class="show-more" style="background-color: #fff">
                            <div class="pad-top-20">
                                <span ng-click="showMoreReviews('reviews')">@{{textReviews}}
                                    <i class="@{{ iconReviews }}"></i>
                                </span>
                            </div>
                        </div>
                        @endif @if($school->settings->map)
                        <!-- SM - XS  contact & stats section -->
                        ...
                        <div>
                            <div class="box left-box1" style="height: 240px;">
                                ...
                                <div class="col-lg-12" style="">
                                    ...
                                    <span>
                                        <i class="fa fa-map-marker pull-left pad-top-3 xs-text-incr-85 " aria-hidden="true"></i>
                                    </span>
                                    ...
                                    <div class="hidden-xs">
                                        <span>
                                            <i class="fa fa-street-view pull-left pad-top-3 " aria-hidden="true"></i>
                                        </span>
                                    ...
                                    <div class="pad-top-20"></div>
                                    <span>
                                        <i class="fa fa-phone pull-left pad-top-2 xs-text-incr-85" aria-hidden="true"></i>
                                    </span>
                                    ...
                                    <div class="hidden-xs ">
                                        ...
                                        <div class="pad-top-20"></div>
                                        <span>
                                            <i class="fa fa-envelope  pull-left pad-top-2 " aria-hidden="true"></i>
                                        </span>
                                        <span class="pull-left pad-left-5 ellipsis">
                                    ...
                                    <span ng-if="contactInfo.website">
                                        ...
                                        <div class="pad-top-20"></div>
                                        <span>
                                            <i class="fa fa-globe pull-left pad-top-3 xs-text-incr-85" aria-hidden="true"></i>
                                        </span>
                                        <span class="pull-left pad-left-5 ellipsis">
                                            <a href="http://@{{contactInfo.website}}/" target="_blank">@{{contactInfo.website}}</a>
                                        </span>
                                    </span>
                        ...
                        <div class="">
                            ...
                            <div class=" box left-box2 sc-t-grey">
                                <div class="col-lg-12 margin-top-30" id="box-2nd" style="">
                                    <span>
                                        <i class="fa fa-trophy pull-left pad-top-3 " aria-hidden="true"></i>
                                    </span>
                                    ...
                                    <div ng-show="contactInfo.type_id==1 || contactInfo.type_id==2 ">
                                        <div class="pad-top-20"></div>
                                        <span>
                                            <i class="fa fa-paint-brush pull-left pad-top-3 " aria-hidden="true"></i>
                                        </span>
                                    ...
                                    <div class="pad-top-20"></div>
                                    <span>
                                        <i class="fa fa-graduation-cap pull-left pad-top-3 " aria-hidden="true"></i>
                                    </span>
                            ...
                            @endif @if($school->admin->subscription->plan_id == 2) @if(auth()->check()) @if(auth()->user()->role != 'school') @if(auth()->user()->apply->contains($school))
                            ...
                            @else @if(auth()->user()->connectedSchool->contains($school))
                            <nav data-spy="affix" data-offset-top="1160" id="connectionButton">
                            ...
                            <nav data-spy="affix" data-offset-top="1170" id="connectionButton">
                                <button id="submButton" type="button" class="affix-button sc-orange sc-t-white center-block" data-toggle="modal" data-target="#connect-modal"
                                    ng-disabled="!showButton">
                            ...
                            <nav data-spy="affix" data-offset-top="1180" id="interestButton" style="top: 120px!important">
                                <button id="interestButton" type="button" class="affix-button sc-orange sc-t-white center-block" data-toggle="modal" data-target="#interest-modal">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="panel-body">
                            <img class="pull-left margin-right-10" style="height: 45px;" ng-src="/images/schools/@{{contactInfo.logo.full_path}}"> @if(auth()->check() && auth()->user()->role == 'student')
                            ...
                            <span>@{{ contactInfo.name }}: Με τη σύνδεση σας, το δημόσιο προφίλ σας θα φαίνεται στο εκπαιδευτικό
                                ίδρυμα</span>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" ng-click="sendRequest()" data-dismiss="modal" class="btn btn-info" ng-class="[{'disabledButton': !(selectedStudy && selectedStatus)}]"
                                ng-disabled="!(selectedStudy && selectedStatus)">@lang('profile.modal.send')</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="interest-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="top: 100px;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="panel-body">
                            <img class="pull-left margin-right-10" style="height: 45px;" ng-src="/images/schools/@{{contactInfo.logo.full_path}}">
                            ...
                            <div class="">
                                <input type="radio" ng-model="interestStudent" value="student"> Μαθητής
                                <br>
                                <input type="radio" ng-model="interestStudent" value="guardian"> Γονέας
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer" style="margin-bottom: 40px;">
                            <button type="button" class="btn btn-default" data-dismiss="modal">@lang('profile.modal.abort')</button>
                            <button type="button" ng-click="sendInterest()" data-dismiss="modal" class="btn btn-info" ng-class="[{'disabledButton': !(interestStudy && interestName)}]"
                                ng-disabled="!(interestName && interestTel && interestEmail && interestStudy)">@lang('profile.modal.send')</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="panel " style="background-color: #324c5a;">
                        <div class="panel-heading" style="height: 55px; color: #fff">
                            ...
                            <h3 class="pull-left panel-title" style="margin: 8px 0 0 15px;">Υποτροφία @{{'>> send id here
                                <<< '}}</h3>
                        </div>
        ...
        .controller("profileCtrl", function ($timeout, $scope, $http, $sce) {
            ...
            $scope.sendRequest = function () {
                if ($scope.selectedStudy && $scope.selectedStatus) {
                    $scope.sendRequestToSchool = $http.post('/api/request/school ', {
                        'school
                                    ': $scope.contactInfo.id, 'study ': $scope.selectedStudy, 'status ': $scope.selectedStatus }, {
                            headers: {
                            'X-Requested-With ': 'XMLHttpRequest ',
                            'X-CSRF-TOKEN ': window.Scholio.csrfToken
                        }
            ...
            $scope.sendInterest = function () {
                ...
                $scope.sendInterestToSchool = $http.post('/api/interest/school ', {
                    'school_id
                                    ': $scope.contactInfo.id, 'study_id ': $scope.interestStudy, 'name ': $scope.interestName, 'email
                                    ': $scope.interestEmail, 'tel ': $scope.interestTel, 'student ': $scope.interestStudent }, {
                            headers: {
                        'X-Requested-With ': 'XMLHttpRequest ',
                        'X-CSRF-TOKEN ': window.Scholio.csrfToken
                    }
