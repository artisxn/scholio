        ...
        <div class="modal-content">
            <form id="form-study-edit-{{ $certificate->id }}" method="POST" action="{{ route('teacher-cv-certificate-edit') }}" name="form-studies">
                            ...
                            <div class="input-container">
                                ...
                                <div class="typeahead__container col-sm-8 polyfill-input-sc">
                                    <div class="typeahead__field typeahead__query">
                                        <input label="@lang('teacher_profile.section.studiesTitle')" class="js-typeahead-studies demo-form ad-input" name="degree" type="text" placeholder=""
                                ...
                                <div class="typeahead__container col-sm-8 polyfill-input-sc">
                                    <div class="typeahead__field typeahead__query">
                                        <input label="@lang('teacher_profile.section.studiesInstitute')" class="js-typeahead-university demo-form ad-input" name="university" type="text"
                                ...
                                <div class="col-sm-8 polyfill-input-sc">
                                    <input type="text" label="@lang('teacher_profile.since')" name="start" class="demo-form ad-input" id="datepickerStudiesFromEdit" value="{{ $certificate->from }}">
                                ...
                                <div class="clearfix"></div>
                                <div class="col-sm-8 polyfill-input-sc">
                                    <input type="text" label="@lang('teacher_profile.until')" name="end" class="demo-form ad-input" id="datepickerStudiesEndEdit" value="{{ $certificate->until }}">
                                    <i class="icon-inp fa fa-calendar-o"></i>
                                    {{--
                                    <img src="/new/img/teacher/graduationMono.png" style="height: 22px; margin-top: -92px"
                                        alt="">--}}
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onClick="document.getElementById('delstudy-{{ $certificate->id }}').value = 'yes'; document.getElementById('form-study-edit-{{ $certificate->id }}').submit()" class="btn btn-primary" data-dismiss="modal">@lang('teacher_profile.delete')</button>
                    <button type="button" onClick="document.getElementById('form-study-edit-{{ $certificate->id }}').submit()" data-dismiss="modal" class="btn btn-info">@lang('teacher_profile.save')</button>
                </div>
            </form>
        </div>
    </div>
