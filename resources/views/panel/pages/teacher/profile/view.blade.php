        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal m-t-20" method="POST" action="/panel/teacher/profile/" accept-charset="UTF-8" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        <div class="form-group" align="center">
                            <img src="/images/teachers/" height="100px">
                        </div>
                        <div class="col-md-6">
