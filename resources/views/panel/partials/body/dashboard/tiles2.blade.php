...
<div class="row">
    ...
    <div class="col-lg-5 col-md-8 col-sm-6">
        <a href="{{ url('/panel/school/studies') }}" id="btn-studies">
            <div class="panel-box box2">
                <img src="/panel/assets/images/dashBoard/studies.png"        alt="studies image" class="panel-image hidden"   id="img-studies-color">
                <img src="/panel/assets/images/dashBoard/studiesOutline.png" alt="studies image" class="panel-image visible"  id="img-studies-black">
