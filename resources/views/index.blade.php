 ...
 ng-controller="landCtrl" data-ng-init="fetchTypes" scroll ng-cloak>
	...
	<main id="main" class="main-landing">
		...
		<section id="sc-landing-sec5" class="sc-landing-sec3" style="overflow-x: hidden!important; background-color: #f1f8fa; min-height: 450px!important;" >
			<div class="container" >
				<div class="row" style="filter: grayscale(0.7); opacity: 0.7">
					...
					<div class="col-sm-3 col-xs-6"><a href="http://ideatree.gr/" target="_blank"><img class="img-support" src="/new/img/support/ideatree-logo.png" alt="" style="height: 55px;  display: inline-block; margin-top: 10px;"></a></div>
					<div class="col-sm-3 col-xs-6"><a href="http://www.eoellas.org/" target="_blank"><img class="img-support" src="/new/img/support/eoelogo.png" alt="" style="height: 65px;  "></a></div>
