...
<html lang='en'>
    ...
    <style>
        ...
        .lang{color: #fff; font-size: 90%; font-weight: 300; opacity: 0.7}
        .selected{color: #fff; font-size: 120%; font-weight: 400}
        ...
        @media (min-width: 576px) and (max-width: 768px) {
            ...
            #particles,#home{min-height: 700px; max-height: 595px; }
        }
        @media (max-width: 575px) {
            .text1,.text2{font-size: 175%; margin-top: 17px;}
            #particles,#home{min-height: 760px; max-height: 595px; margin-top: -80px;}
            #countdown{ display:none;}
            .slideshow{max-height: 710px; margin-top: -50px!important; }
            .slideshow>ol>li>div>h2{font-size: 145%}
            .slideshow>ol>li>div>p{font-weight: 400; }
            .description{padding-left: 15px; padding-right: 15px; margin-top: 105px; line-height: 26px}
    ...
    <body style="overflow-x: hidden!important;" ng-app="soonApp" ng-controller="soonCtrl" data-ng-init="init()">
        ...
        <!-- Main Wrapper -->
        <div id='wrapper' style="overflow-x: hidden!important;">



            <!-- Intro Section -->

            <div id="particles" style="overflow-x: hidden!important;">
            </div>



            <section class='' id='home' style="overflow-x: hidden!important;">
                <div class='container lang-cont' style=" overflow-x: hidden!important; " >
                    <div >
                        <div style="float: right; margin-top: 30px; color: #fff">
                            <a href="/lang/en" class="lang"> English </a> &nbsp;&nbsp;&nbsp;<a href="/lang/el" class="lang selected"> Greek   </a>
                    ...
                    <div class='intro-text text-center' >
                        ...
                        <div class="text2">Σύντομα κοντά σας, <br class="hidden-sm-up">με μια σπουδαία ιδέα !</div>
                            ...
                            <div class='row justify-content-center' >
                                <div class='col-md-7 col-sm-10' style="opacity: 0.45">
          ...
          <!-- Slideshow Section -->
            <div class="slideshow" id="slideshow" style="overflow-x: hidden!important;">
                            <ol class="slides">
                                <li class="current">
                                ...
                                <li>
                                    <div class="description">
                                        ...
                                        <p>Είσαι μαθητής ή φοιτητής; Αναζήτησε υποτροφίες γρήγορα, εύκολα και στοχευμένα από κάθε σου συσκευή και εκδήλωσε άμεσα το ενδιαφέρον σου προβάλλοντας τις ιδιαίτερες δεξιότητες και το ταλέντο σου.</p>
                                    </div>
            ...
            <!-- About Section -->
            <section class='section about-section' id='about' style="overflow-x: hidden!important;">
                <div class='container' >
            ...
            <!-- Newsletter Section -->
            <section class='section newsletter-section' id='newsletter' style="background-color: #008da5; overflow-x: hidden!important;" >
                <div class='container' >
            ...
            <!-- Contact Section -->
            <section class='section contact-section' id='contact' style="background-color: #DEEAED; overflow-x: hidden!important;">
                        ...
                        <div class='col-md-8' >
                            ...
                            <div class='section-header' id="about-divider">
                                ...
                                <p class='' style='color: #777!important;'>
                                    Εάν είστε γονέας, μαθητής ή καθηγητής και σας ενδιαφέρει η ιδέα του Schol.io ή κάποιο εκπαιδευτικό ίδρυμα με δραστηριότητα στο χώρο των υποτροφιών και σας ενδιαφέρει η συμμετοχή σας στη δοκιμαστική περίοδο του Schol.io αφήστε μας το σχόλιό σας ή εκδηλώστε το ενδιαφέρον σας.
                                </p>
                            </div>
        ...
        angular.module("soonApp",[])
                .controller("soonCtrl",function ($scope) {
                    $scope.init=function (){
                        $scope.eng=true;
                    };
