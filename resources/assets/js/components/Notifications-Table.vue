<template>
    <div class="row">
                        ...
                        <div class="p-20">
                            <div class="table-responsive">
                                <table class="table table-striped m-0 noti-table">
                                    ...
                                    <tbody>
                                        <tr v-if="buttonsDisabled"> 
                                            <td>-- PRELOADER --</td>
                                        </tr>
                                        <tr v-for="notification in notifications" v-show='notification.type == "App\\Notifications\\UserAppliedForConnection"' v-else>
                                            ...
                                            <td class="text-center" v-if="notification.data.role == 'student'"> {{ notification.data.study.name }}</td>
                                            <td class="text-center" v-if="notification.data.role == 'teacher'"> {{ notification.data.study }}</td>
        ...
        <modal name="studiesStudent" style="top: -150px">
                ...
                <div class="modal-content">
                        <div class="panel " style="background-color: #324c5a; height:90px; border-bottom-right-radius: 0; border-bottom-left-radius: 0; padding: 10px">
                            <div class="panel-heading" style=" color: #fff">
                                <button type="button" class="btn pull-right btn-close" @click="hide">
                                    x
                                </button>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" @click="hide">{{lang('profile.modal.abort')}}</button>
                            <button type="button" class="btn btn-info" @click="accept">Αποδοχή</button>
                        </div>
                </div>
            </div>
        </modal><!-- /.modal -->
